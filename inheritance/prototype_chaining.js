/* This is a really basic inheritance method
 * NOTE Not very efficient as when extending it creates a new instance
 * NOTE As there is a prototype chain the lookup is not so fast
 */
...
console.log(myShape2.name);

console.log('Triangle');
console.log('--------Triangle.prototype = TwoDShape');
console.log('-----------------------------TwoDShape.prototype = Shape');
